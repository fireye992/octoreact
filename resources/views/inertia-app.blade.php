...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        {{-- Meta tags SEO from your old layout --}}
        <title inertia>@yield('title', 'OcToPus Philosophe à tentacules')</title>
        ...
        @routes
        @viteReactRefresh
        @vite(['resources/js/app.jsx', "resources/css/app.css"]) {{-- Make sure your CSS is included here --}}
        @inertiaHead
        <script src="https://apis.google.com/js/platform.js"></script>
    </head>
    <body class="font-sans antialiased text-primary dark:text-secondary bg-primary dark:bg-secondary">

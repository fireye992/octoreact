...
<head>
    ...
    <script>
        ...
        })(w, document, 'script', 'dataLayer', 'GTM-K8X7JRD7');
    </script>
    ...
    @stack('head_scripts')
    @stack('head_meta')
    @vite(['resources/css/app.css', 'resources/js/app.js']) {{-- Assure-toi que app.js existe et charge tes JS non-React --}}
</head>
<body class="antialiased text-primary dark:text-secondary ">
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K8X7JRD7" height="0" width="0"<!DOCTYPE html>

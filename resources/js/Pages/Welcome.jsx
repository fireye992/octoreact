...
import { Link } from '@inertiajs/react'; // Assure-toi d'importer Link si tu l'utilises

export default function Welcome({ auth, navigationItems, canLogin, canRegister, laravelVersion, phpVersion }) { // Ajoute laravelVersion et phpVersion à tes props
    return (
        <MainLayout
